...
def call(Map pipelineParams) {
    ...
    pipeline {
        ...
        environment {
            ...
            JFROG_DOCKER_REGISTRY = "flipcart01.jfrog.io"
        ...
        stages {
            ...
            stage ('Deploy to Dev') {
                ...
                script {
                    ...
                    k8s.k8sHelmChartDeploy("${env.APPLICATION_NAME}", "${env.DEV_ENV}", "${env.HELM_CHART_PATH}", "${env.DOCKER_IMAGE_TAG}")
...
def dockerBuildandPush() {
    return {
        ...
        sh "docker login -u ${JFROG_CREDS_USR} -p ${JFROG_CREDS_PSW} flipcart01.jfrog.io" 
